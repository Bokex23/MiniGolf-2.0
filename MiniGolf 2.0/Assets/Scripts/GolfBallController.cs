...
public class GolfBallController : MonoBehaviour
{
    ...
    [SerializeField] private AudioSource sonidoGolpe; // Arrastra aquí tu Audio Source del golpe desde Unity
    ...
    void FixedUpdate()
    {
        ...
        // Reproducir sonido al golpear la pelota
        if (sonidoGolpe != null)
        {
            sonidoGolpe.Play();
        }
    ...
    void OnGUI()
    {
        ...
        GUI.Box(new Rect(15, 15, 290, 110), "");
